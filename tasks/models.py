...
STATUS_CHOICES = [  ('in_progress', '⏳ جاري العمل'),
    ...
    ('publish', 'تم النشر'),
    ('done', '✅ مكتملة'), ]
TYPE_IMAGE = [  ('صورة بارزة', 'صورة بارزة'),
    ('صورة داخلية', 'صورة داخلية'), ]
IS_NEED_IMAGE = [  ('NO', 'لا '),
    ('YES', 'نعم'), ]
IMAGE_STATUS = [  ('in_progress', '⏳ جاري العمل'),
...
class Task(models.Model):
    ...
    is_need_image= models.CharField(max_length=20,choices=IS_NEED_IMAGE,default='NO',verbose_name='هل تحتاج لصور؟', null=True, blank=True)
    ...
    published_url= models.TextField(max_length=7000, verbose_name="الرابط المنشور", blank=True, null=True)
